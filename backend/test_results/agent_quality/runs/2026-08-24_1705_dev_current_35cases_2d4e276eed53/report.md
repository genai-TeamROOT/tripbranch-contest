...
- 실행 ID: `2026-08-24_1705_dev_current_35cases_2d4e276eed53`
- 실행 시각: 2026-08-24T17:10:15+09:00
- 프롬프트 기준선: `current`
- 평가셋: `dev` · 35건 / 50턴
- 골드셋 해시: `2d4e276eed53`
...
| 지표 | 결과 |
| --- | ---: |
| 클라이언트 지연시간 p50 | 7.47초 |
| 클라이언트 지연시간 p95 | 12.32초 |
...
비교 대상: `2026-08-24_1147_dev_current_35cases_2d4e276eed53`
