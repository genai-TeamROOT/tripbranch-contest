...
- 실행 ID: `2026-08-27_1208_dev_current_35cases_99825c9642fa`
- 실행 시각: 2026-08-27T12:16:32+09:00
- 프롬프트 기준선: `current`
- 평가셋: `dev` · 35건 / 50턴
- 골드셋 해시: `99825c9642fa`
...
| 지표 | 결과 |
| --- | ---: |
| 클라이언트 지연시간 p50 | 8.09초 |
| 클라이언트 지연시간 p95 | 49.30초 |
...
비교 대상: `2026-08-27_1158_dev_current_35cases_99825c9642fa`

- intent_accuracy: +0.0800
- macro_f1: +0.0200
- condition_field_accuracy: +0.0787
