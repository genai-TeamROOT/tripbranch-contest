...
- 실행 ID: `2026-08-20_2044_dev_current_35cases_2d4e276eed53`
- 실행 시각: 2026-08-20T20:47:21+09:00
- 프롬프트 기준선: `current`
- 평가셋: `dev` · 35건 / 50턴
- 골드셋 해시: `2d4e276eed53`
...
| 지표 | 결과 | 의미 |
| --- | ---: | --- |
| Intent Accuracy | 98.0% | 전체 턴에서 Intent가 일치한 비율 |
| Intent Macro F1 | 0.991 | Intent별 F1을 동등하게 평균낸 균형 점수 |
| 조건 필드 정확도 | 93.2% | 기대 조건 필드 하나하나가 일치한 비율 |
| 최종 조건 완전 일치율 | 86.7% | 조건을 기대한 케이스에서 모든 필드가 맞은 비율 |
...
| 지표 | 결과 |
| --- | ---: |
| 클라이언트 지연시간 p50 | 5.31초 |
| 클라이언트 지연시간 p95 | 9.30초 |
...
| MODIFY | 11 | 100.0% | 90.9% | 0.952 |
| OUT_OF_SCOPE | 1 | 100.0% | 100.0% | 1.000 |
| RECOMMEND | 26 | 96.3% | 100.0% | 0.981 |
...
- 조건 불일치: `time_available` 기대 `240` / 실제 `360`
- 오류: 없음
...
비교 대상: `2026-08-14_1546_dev_35cases_2d4e276eed53`

- intent_accuracy: -0.0200
- macro_f1: -0.0095
- condition_field_accuracy: -0.0568
