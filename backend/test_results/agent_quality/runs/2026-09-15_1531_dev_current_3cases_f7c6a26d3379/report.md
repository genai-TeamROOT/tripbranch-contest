...
- 실행 ID: `2026-09-15_1531_dev_current_3cases_f7c6a26d3379`
- 실행 시각: 2026-09-15T15:31:31+09:00
- 프롬프트 기준선: `current`
...
| 지표 | 결과 |
| --- | ---: |
| 클라이언트 지연시간 p50 | 9.48초 |
| 클라이언트 지연시간 p95 | 12.15초 |

## Intent별 Precision / Recall / F1

| Intent | 표본 수 | Precision | Recall | F1 |
| --- | ---: | ---: | ---: | ---: |
| RECOMMEND | 3 | 100.0% | 100.0% | 1.000 |
