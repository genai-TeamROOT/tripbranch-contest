...
- 실행 ID: `2026-08-14_1546_dev_35cases_2d4e276eed53`
- 실행 시각: 2026-08-14T15:51:22+09:00
- 평가셋: `dev` · 35건 / 50턴
- 골드셋 해시: `2d4e276eed53`
...
| 멀티턴 통과율 | 100.0% | 2턴 이상 케이스가 Intent·조건을 모두 통과한 비율 |
...
| 지표 | 결과 |
| --- | ---: |
| 클라이언트 지연시간 p50 | 6.34초 |
| 클라이언트 지연시간 p95 | 20.32초 |
...
- 기대 Intent: `SCHEDULE`
- 실제 Intent: `SCHEDULE`
- 조건 불일치: `time_available` 기대 `240` / 실제 `210`
- 오류: 없음
