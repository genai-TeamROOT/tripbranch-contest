...
- 실행 ID: `2026-09-15_1628_dev_current_103cases_c210d85f009e`
- 실행 시각: 2026-09-15T16:51:02+09:00
- 프롬프트 기준선: `current`
...
| 지표 | 결과 | 의미 |
| --- | ---: | --- |
| Intent Accuracy | 99.2% | 전체 턴에서 Intent가 일치한 비율 |
| Intent Macro F1 | 0.994 | Intent별 F1을 동등하게 평균낸 균형 점수 |
| 조건 필드 정확도 | 99.4% | 기대 조건 필드 하나하나가 일치한 비율 |
| 최종 조건 완전 일치율 | 98.4% | 조건을 기대한 케이스에서 모든 필드가 맞은 비율 |
| 멀티턴 통과율 | 91.3% | 2턴 이상 케이스가 Intent·조건을 모두 통과한 비율 |
| 전체 케이스 통과율 | 98.1% | 케이스 단위로 모든 검증을 통과한 비율 |
...
| 지표 | 결과 |
| --- | ---: |
| 클라이언트 지연시간 p50 | 11.70초 |
| 클라이언트 지연시간 p95 | 29.29초 |
...
| GENERAL | 14 | 100.0% | 100.0% | 1.000 |
| INFO | 19 | 100.0% | 100.0% | 1.000 |
| MODIFY | 17 | 100.0% | 94.1% | 0.970 |
| OUT_OF_SCOPE | 5 | 100.0% | 100.0% | 1.000 |
| RECOMMEND | 55 | 98.2% | 100.0% | 0.991 |
...
| GENERAL | 0 | 14 | 0 | 0 | 0 | 0 | 0 |
| INFO | 0 | 0 | 19 | 0 | 0 | 0 | 0 |
| MODIFY | 0 | 0 | 0 | 16 | 0 | 1 | 0 |
| OUT_OF_SCOPE | 0 | 0 | 0 | 0 | 5 | 0 | 0 |
| RECOMMEND | 0 | 0 | 0 | 0 | 0 | 55 | 0 |
...
### DEV-021 — 위치만 변경해도 날씨 유지

- 기대 Intent: `RECOMMEND, MODIFY`
- 실제 Intent: `RECOMMEND, MODIFY`
- 조건 불일치: `search_center` 기대 `'왕십리'` / 실제 `'왕십리역'`
- 오류: 없음
...
비교 대상: `2026-09-15_1605_dev_current_103cases_c210d85f009e`

- intent_accuracy: +0.0229
- macro_f1: +0.0202
- condition_field_accuracy: +0.0114
- case_pass_rate: +0.0388
