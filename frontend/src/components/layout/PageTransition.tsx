/*
 * 역할: 화면이 바뀔 때 새 화면이 살짝 내려앉으며 나타나게 감싼다.
 ...
 * 화면이 즉시 그려지면서 220ms 만에 제자리로 내려앉는다.
 *
 * **움직이는 방향이 위에서 아래인 이유는 index.css의 tb-page-enter 주석에 있다.**
 * 아래에서 떠오르게 두면 셸이 그만큼 넘쳐서 전환 때마다 스크롤바가 떴다.
 *
 ...
 * 떠오르면 안 된다.
 *
 * `prefers-reduced-motion: reduce`인 환경에서는 움직이는 동작만 빠지고, 서서히
